...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:z1ayuDusPITNOhzvmx3nLpFax+tv7Hu7mdrjtgW3ZeA=",
        version = "v0.6.2",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_mcosta74_pgx_slog",
        importpath = "github.com/mcosta74/pgx-slog",
        sum = "h1:zsyxnYEjJ2hVQYC/SxcHkzcb5K+CSgmLVcBsK6460M8=",
        version = "v0.3.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Ls5Dto11Tknh8CFbaMTSBD0fgMlTqJWq8/Df4LPaeQ0=",
        version = "v1.0.41",
    )
    go_repository(
